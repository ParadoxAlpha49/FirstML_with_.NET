...
namespace PrintDateandTimeML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\Users\User\Downloads\wikipedia-detox-250-line-data.tsv";
        private static string MODEL_FILEPATH = @"C:\Users\User\AppData\Local\Temp\MLVSTools\printDateandTimeML\printDateandTimeML.Model\MLModel.zip";
